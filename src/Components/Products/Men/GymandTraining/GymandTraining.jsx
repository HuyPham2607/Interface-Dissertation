...
function GymandTraining() {
    ...
    const identifiedProduct = prodFilter.filter((p) => p.title === 'Men' && p.identified === 'GymandTrainingmens');
    let showProducts;
    if (sortby === '') {
            ...
            <div className=" py-5 wrapper-item">
                ...
                <div className="header-filter ">
                    ...
                    <div className="d-flex justify-content-between ">
                        <span className="headline-page-route">Result {identifiedProduct.length}</span>
