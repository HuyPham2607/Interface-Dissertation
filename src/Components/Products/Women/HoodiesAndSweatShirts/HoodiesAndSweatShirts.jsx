...
function HoodiesAndSweatShirtsWomen() {
    const [onfilter, setOnfilter] = useState(true);
    const [products, setProducst] = useState([]);
    const [sortby, setSortBy] = useState('');
    const productssssssss = useSelector((state) => state.products.products);
    ...
    useEffect(() => {
        setProdFilter(
            productssssssss.filter((item) =>
                Object.entries(filters).every(([key, value]) => item[key].includes(value)),
            ),
        );
    }, [productssssssss, filters]);
    ...
    const identifiedProduct = prodFilter.filter((p) => p.identified === 'Hoodies&Sweatshirtswomens');
            ...
            <div className=" py-5 wrapper-item">
                ...
                <div className="sidebar-talet close-sidebar-tablet" id="filter-tablet">
                    ...
                    <div className="mx-5 sidebar-bottom-filter">
                        <button className="btn-bottom-apply">Add To Bag</button>
                    </div>
                </div>
            </div>
        </div>
...
export default HoodiesAndSweatShirtsWomen;
