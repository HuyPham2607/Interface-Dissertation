...
function PerformanceEseentinals() {
    ...
    const identifiedProduct = prodFilter.filter((p) => p.identified === 'PerformanceEssentinalswomens');
...
export default PerformanceEseentinals;
